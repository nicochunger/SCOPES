...
## Features
- **Fair Scheduling:** Prioritizes observing time across different programs, respecting scientific priorities.
- **Sensibility Constraints:** Ensures observations are made only when conditions meet predefined limits.
- **Efficiency Optimization:** Identifies the best moments to observe specific targets to maximize telescope usage and data quality.
- **Customizable:** Allows users to define custom merit functions and schedulers to fit specific needs.
